...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name:  demo
          image: XXXXXX/demo:hello-config-args
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name:  demo
          image: XXXXXX/demo:hello-config-file
          ports:
            - containerPort: 8888
          volumeMounts:
          - mountPath: /config/
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name:  demo
          image: XXXXXX/demo:hello-config-env
          ports:
            - containerPort: 8888
          env:
            - name: GREETING
...
* Use our hello app from XXXXXX repo. And to call the $GREETINGS env use secrets.